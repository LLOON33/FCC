...
<!-- END NAVBAR -->
    ...
    <section class="section vh-100" id="home">
        <video autoplay muted loop id="myVideo">
            <source src="Video/mecanico.mp4" type= "video/mp4">
        </video>
            ...
            <div class="home-desc-center">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div>
                                <h1 class="text-white home-title mb-0">Bienvenido Mecanico</h1>
                                <div class="mt-4">
                                ...
                                <div class="mt-4">
                                    <a href="vehiculos_fallas.php" class="btn btn-outline-white">Informacion de los vehiculos</a>
                                </div>
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
