            ...
            <div class="home-desc-center">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div>
                                <h1 class="text-white home-title mb-0">Administrador</h1>
                                <div class="mt-4">
                                    <a href="vehiculo_admin.php" class="btn btn-outline-white">Datos de Vehículos</a>
                                </div>
                                <div class="mt-4">
                                    <a href="usuario.php" class="btn btn-outline-white">Datos de usuario</a>
                                </div>
                                <div class="mt-4">
                                    <a href="graficos_mantencion.php" class="btn btn-outline-white">Informacion de mantencion</a>
                                </div>
                                <div class="mt-4">
                                    <a href="graficos_solicitud.php" class="btn btn-outline-white">Informacion de solicitudes</a>
                                </div>
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
